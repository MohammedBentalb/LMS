...
if(empty($_FILES['course-image']) && round($_FILES['course-image']['size'] / (1024 * 1024), 2) > $MAXMB && round($_FILES['course-image']['size'] / (1024 * 1024), 2) <= 0 && !key_exists($_FILES['course-image']['type'], $allowedTypes)){
    $fileError = true;
