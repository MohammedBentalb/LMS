...
ADD UPDATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP -- ADDING created_att AND updated_at TO TEST ADDING USING ULTER AND ALSO TO TEST WHO DOES TIMESTAMP WORKS WHEN UPDATING A COURSE
