...
<body>
    ...
    <form action="" method="POST" class="course-form" enctype="multipart/form-data">
        ...
        <div class="form-field">
            ...
            <input id="course-title" type="text" placeholder="What should we calll your course?">
            <p class="error-field is-hidden" data-error-name="title" >ana mol error ana</p>
        </div>
        <div class="form-field">
            <label for="course-image" class="img-lable">Course banner</label>
            <input type="file" id="course-image" id="course-image" accept=".jpg,.jpeg,.png.web" required>
            <p class="error-field is-hidden" data-error-name="image">ana mol error ana</p>
        </div>
        <div class="form-field">
        ...
        <div class="form-field">
            ...
            <select name="select-type" id="course-type">
        ...
        <div class="form-field">
            ...
            <p class="error-field is-hidden" data-error-name="content">ana mol error ana</p>
        </div>
